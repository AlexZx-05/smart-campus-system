      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-sky-100 bg-sky-50">
            ...
            <div>
              <h3 className="text-3xl font-semibold tracking-tight text-slate-900 md:text-2xl">Notifications</h3>
              <p className="mt-1 text-sm text-slate-600 md:text-sm">Real-time updates from admin announcements and teacher messages.</p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="p-3">
            {visibleItems.map((item, index) => (
              <article key={item.id} className="mb-3 rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm last:mb-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="truncate text-2xl leading-none font-semibold text-slate-900 md:text-xl">{item.actorName}</p>
                      ...
                      <div className="flex shrink-0 items-center gap-2">
                        ...
                        <span className="rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-500">{timeAgo(item.createdAt)}</span>
                      </div>
                    </div>
                    <div className="mt-2.5 rounded-2xl border border-slate-200 bg-slate-50 p-3">
                      <p className="text-sm leading-7 text-slate-800 md:text-base">{item.bodyText}</p>
                    </div>
                  </div>
                </div>
              </article>
